...
export PATH=/usr/local/prokka/latest/bin/prokka/:/usr/local/hmmer/2.3.2/:/usr/local/rnammer/1.2/:/usr/local/tbl2asn/01052015:/usr/local/signalp/4.1c/:/usr/local/parallel/20150822:$PATH
